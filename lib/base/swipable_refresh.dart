...
class FRefreshController {
  ...
  ///
  /// Get the pull-down refresh status. See [RefreshState] for confirm
  ...
  ///
  /// Get the pull-up loading status. See [LoadState] for confirm
  ...
  ///
  /// Current scroll information. See [ScrollMetrics] for confirm.
  ...
  void _setFRefreshState(FRefreshState fRefreshState) {
...
class FRefresh extends StatefulWidget {
  ...
  ///
  /// [Refresh] controller. See [Refresh Controller] for confirm.
...
//  final bool shrinkWrap;
  ...
  @override
  FRefreshState createState() => FRefreshState();
}

class FRefreshState extends State<FRefresh> {
...
class Footer extends SingleChildRenderObjectWidget {
  ...
  @override
  FooterState createRenderObject(BuildContext context) => FooterState();
}

class FooterState extends RenderSliverToBoxAdapter {
  FooterState({
    super.child,
  });
