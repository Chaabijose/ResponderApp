...
class ChatShimmerLoader extends StatelessWidget {
  ...
  const ChatShimmerLoader({super.key, this.baseColor = kPrimary});
        ...
        builder: IntrinsicHeight(
            child: Container(
                margin: const EdgeInsets.only(
                    top: 12, bottom: 5, left: 24, right: 4),
                    ...
                    children: [
                      Container(
                          constraints: const BoxConstraints(
                              minWidth: 120, maxWidth: 200, minHeight: 55),
  ...
  Widget chatOtherSkeleton() {
    return SkeletonLoader(
        ...
        builder: Container(
            margin:
                const EdgeInsets.only(top: 5, bottom: 5, left: 0, right: 24),
            width: double.infinity,
            child: Column(
                ...
                children: [
                  Container(
                      constraints: const BoxConstraints(
                          minWidth: 120, maxWidth: 180, minHeight: 50),
                      decoration: const BoxDecoration(
                        color: kWhite,
                        borderRadius: BorderRadius.only(
